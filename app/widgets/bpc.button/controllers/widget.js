...
function applyProperties(properties) {
    ...
    if (!_initted) {
        ...
        _applyLabelProperties(_properties);
        
        if(_properties.faicon) {
        	$.label.icon = _properties.faicon;
        	$.fa.refresh();
        }
...
function _onTouchstart(e) {
    ...
    if (_properties.activeStyle) {
        ...
        _applyLabelProperties(_properties.activeStyle);
    }
...
function _onTouchend(e) {
    ...
    if (_properties.defaultStyle) {
        ...
        _applyLabelProperties(_properties.defaultStyle);
    }
